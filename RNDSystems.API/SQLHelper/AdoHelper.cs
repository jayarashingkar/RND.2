...
namespace RNDSystems.API.SQLHelper
{
    public class AdoHelper : IDisposable
    {
        ...
        public AdoHelper()
        {
            ConnectionString = ConfigurationManager.ConnectionStrings["RND"].ConnectionString;
        ...
        /// <param name="ChangeDB">Connect to different Database</param>
        ...
        /// <returns></returns>
       // public SqlCommand CreateCommand(string qry, CommandType type, bool ChangeDB = false, params object[] args)
        public SqlCommand CreateCommand(string qry, CommandType type, string DbName = "RDBPROD", params object[] args)
        {
            if (DbName == "RDBPROD")
            {
                ...
                ConnectionString = ConfigurationManager.ConnectionStrings["RDBPROD"].ConnectionString;
                _connString = ConnectionString;
                Connect();
            }
            ...
            if (DbName == "ROPROD")
            {
                ...
                ConnectionString = ConfigurationManager.ConnectionStrings["ROPROD"].ConnectionString;
                _connString = ConnectionString;
                Connect();
            }
