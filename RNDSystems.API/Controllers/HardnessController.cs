...
{
    public class HardnessController : UnSecuredController
    {
        // GET: Results
        public HttpResponseMessage Post(HardnessViewModel ManulEntryData)
        {
            ...
            try
            {
                ...
                SqlParameter param11 = new SqlParameter("@Hardness", ManulEntryData.Hardness);

                sendMessage.Message = "";
                using (SqlDataReader reader = ado.ExecDataReaderProc("RNDHardnessResults_Insert", "RND", new object[]
